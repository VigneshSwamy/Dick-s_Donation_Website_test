      ...
      <Typography component="h1">About Us</Typography>
        <div className="header">
          <p>This mobile application aims to provide an infrastructure for retailers and donors to provide items to high schoolers on-demand.
            <br></br>Retailers will be able to partner with high schools to tackle specific issues they face and reward their students or teachers for whatever sensible metric they choose, namely battling student
          <ul>
            <li>absenteeism</li>
            <li>student performance</li>
            <li>student-teacher relationship development</li>
          </ul>
          only to name a few use cases.
